                            ...
                            {categories.map((category) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition-all ${filter === category
                                            ...
                                            : 'bg-white dark:bg-dark-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-dark-700 hover:border-primary-400'
                                        }`}
                                >
                                    {category}
                                </button>
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <Link href={item.url} className="group">
                                                <h3 className="text-xl font-bold text-gray-900 dark:text-dark-50 mb-2 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                                    {item.title}
                                                </h3>
                                            </Link>
