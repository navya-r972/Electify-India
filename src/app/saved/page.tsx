    ...
    <>
            <div className="min-h-screen bg-slate-50 dark:bg-dark-900 py-12">
                <div className="container mx-auto px-4 max-w-5xl">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-black dark:text-dark-50">
                            Saved Articles
                        </h1>
                            ...
                            {categories.map((category) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition-all ${filter === category
                                            ...
                                            : 'bg-white dark:bg-dark-800 text-black dark:text-gray-300 border border-gray-300 dark:border-dark-700 hover:border-primary-400'
                                        }`}
                                >
                                    {category}
                                </button>
                    ...
                    {filteredItems.length > 0 ? (
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <Link href={item.url} className="group">
                                                <h3 className="text-xl font-bold text-black dark:text-dark-50 mb-2 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                                    {item.title}
                                                </h3>
                                            </Link>
                                        ...
                                        <button
                                            ...
                                            className="ml-4 p-2 text-black hover:text-red-600 dark:hover:text-red-400 transition-colors"
                        ...
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-dark-50 mb-2">
                                No saved items
                            </h3>
                            ...
                            <Link
                                href="/learn"
                                className="inline-block px-6 py-3 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-all"
                            >
                                Explore Content
                            </Link>
                        </div>
